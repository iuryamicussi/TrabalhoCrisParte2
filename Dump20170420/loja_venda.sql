...
CREATE TABLE `venda` (
  ...
  CONSTRAINT `FK_Forma_Pagamento` FOREIGN KEY (`formaPagamento`) REFERENCES `formapagamento` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2017-04-20 20:23:03
