...
CREATE TABLE `entrada_produto` (
  ...
  CONSTRAINT `FK_Entrada` FOREIGN KEY (`id_entrada`) REFERENCES `entrada` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_Produto_Entrada` FOREIGN KEY (`produto`) REFERENCES `produto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-04-20 20:22:57
